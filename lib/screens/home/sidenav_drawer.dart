          ...
          ExpansionTile(
            ...
            children: [
              ListTile(
                ...
                title: Text(hasOrder ? 'عدل الطلب' : 'اطلب',
                ...
                onTap: () async {
                  if (await DatabaseService.hasData(iuser.uid)) {
                    ...
                    Navigator.of(context).pop();
                    DatabaseService(iuser.uid)
                        .updateUserOrderData('لن أفطر معكم', iuser.name, 300);
                    showPreferences(context);
                  }
                },
              ),
          ...
          ExpansionTile(
            ...
            children: [
              ListTile(
                ...
                title: Text('في شكل أشرطة بيانية',
                    style: TextStyle(color: Colors.indigo[800])),
                onTap: () {
              ...
              ListTile(
                leading:
                    Icon(Icons.donut_large_rounded, color: Colors.indigo[800]),
                title: Text('في شكل حلقي',
                    style: TextStyle(color: Colors.indigo[800])),
                onTap: () {
                  Navigator.pushNamed(context, 'reports_screen',
                      arguments: 'Doughnut');
