    ...
    return StreamBuilder<Object>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return  updateClicked ? const CircleLoading() : Form(
                key: _formKey,
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: fieldDecor(label: 'الاسم').copyWith(filled: false,),
                      ...
                      Slider(
                          ...
                          min: 100,
                          divisions: 8,
                          activeColor: Colors.blue[newStrength ?? userData.strength],
                          inactiveColor: Colors.lightBlue[newStrength ?? userData.strength - 300],
                          thumbColor: Colors.blue[newStrength ?? userData.strength],
                          onChanged: (value) =>
