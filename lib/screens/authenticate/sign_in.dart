      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton.icon(
            ...
            label: const Text('إنشاء حساب' , style: TextStyle(color: Colors.white)),
          )
        ],
      ),
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: (error.isEmpty)? 0 : 20,),
                ...
                signing? const Loading() : ElevatedButton(
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()){
                        ...
                        //           error = (e == 'firebase_auth/wrong-password') ? 'كلمة سر خاطئة' : 'عذرا لم تنجح عملية الدخول';
                        //           signing = false;
                        //         });
                        //       } //catch (e) {
                              //   setState(() {
                              //     error =  'عذرا لم تنجح عملية الدخول';
                              //     signing = false;
                              //   });
                              // }
